        ...
        stage('Build Image') {
            ...
            steps {
                ...
                sh '''
                    ...
                    -Dquarkus.container-image.name=deploying-environments \
        ...
        stage('Deploy - Stage') {
            ...
            steps {
                sh """
                    ...
                    shopping-cart-stage=quay.io/${QUAY_USR}/deploying-environments:build-${BUILD_NUMBER} \
